...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\"j\n" +
	"\n" +
	"Permission\x12\x0e\n" +
	...
	"\vpermissions\x18\x01 \x03(\v2\x10.user.PermissionR\vpermissions2\xa0\x03\n" +
	"\vUserService\x12Q\n" +
	"\x10CreatePermission\x12\x1d.user.CreatePermissionRequest\x1a\x1e.user.CreatePermissionResponse\x12H\n" +
	"\rGetPermission\x12\x1a.user.GetPermissionRequest\x1a\x1b.user.GetPermissionResponse\x12Q\n" +
	"\x10UpdatePermission\x12\x1d.user.UpdatePermissionRequest\x1a\x1e.user.UpdatePermissionResponse\x12Q\n" +
	"\x10DeletePermission\x12\x1d.user.DeletePermissionRequest\x1a\x1e.user.DeletePermissionResponse\x12N\n" +
	"\x0fListPermissions\x12\x1c.user.ListPermissionsRequest\x1a\x1d.user.ListPermissionsResponseB\fZ\n" +
	"./protogenb\x06proto3"
...
var file_proto_user_proto_goTypes = []any{
	...
	(*CreatePermissionRequest)(nil),  // 1: user.CreatePermissionRequest
	(*CreatePermissionResponse)(nil), // 2: user.CreatePermissionResponse
	(*GetPermissionRequest)(nil),     // 3: user.GetPermissionRequest
	(*GetPermissionResponse)(nil),    // 4: user.GetPermissionResponse
	(*UpdatePermissionRequest)(nil),  // 5: user.UpdatePermissionRequest
	(*UpdatePermissionResponse)(nil), // 6: user.UpdatePermissionResponse
	(*DeletePermissionRequest)(nil),  // 7: user.DeletePermissionRequest
	(*DeletePermissionResponse)(nil), // 8: user.DeletePermissionResponse
	(*ListPermissionsRequest)(nil),   // 9: user.ListPermissionsRequest
	(*ListPermissionsResponse)(nil),  // 10: user.ListPermissionsResponse
}
var file_proto_user_proto_depIdxs = []int32{
	0,  // 0: user.CreatePermissionResponse.permission:type_name -> user.Permission
	0,  // 1: user.GetPermissionResponse.permission:type_name -> user.Permission
	0,  // 2: user.UpdatePermissionResponse.permission:type_name -> user.Permission
	0,  // 3: user.ListPermissionsResponse.permissions:type_name -> user.Permission
	1,  // 4: user.UserService.CreatePermission:input_type -> user.CreatePermissionRequest
	3,  // 5: user.UserService.GetPermission:input_type -> user.GetPermissionRequest
	5,  // 6: user.UserService.UpdatePermission:input_type -> user.UpdatePermissionRequest
	7,  // 7: user.UserService.DeletePermission:input_type -> user.DeletePermissionRequest
	9,  // 8: user.UserService.ListPermissions:input_type -> user.ListPermissionsRequest
	2,  // 9: user.UserService.CreatePermission:output_type -> user.CreatePermissionResponse
	4,  // 10: user.UserService.GetPermission:output_type -> user.GetPermissionResponse
	6,  // 11: user.UserService.UpdatePermission:output_type -> user.UpdatePermissionResponse
	8,  // 12: user.UserService.DeletePermission:output_type -> user.DeletePermissionResponse
	10, // 13: user.UserService.ListPermissions:output_type -> user.ListPermissionsResponse
