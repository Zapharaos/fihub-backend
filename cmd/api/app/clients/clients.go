...
func NewClients(health protogen.HealthServiceClient, user protogen.UserServiceClient, broker protogen.BrokerServiceClient, transaction protogen.TransactionServiceClient) Clients {
	return Clients{
		health:      health,
		user:        user,
		broker:      broker,
