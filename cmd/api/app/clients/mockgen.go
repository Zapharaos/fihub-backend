...
//go:generate mockgen -source=../../../../protogen/user_grpc.pb.go -destination=../../../../test/mocks/user_client.go -package=mocks -mock_names=UserServiceClient=UserServiceClient UserServiceClient
//go:generate mockgen -source=../../../../protogen/security_grpc.pb.go -destination=../../../../test/mocks/security_client.go -package=mocks -mock_names=SecurityServiceClient=SecurityServiceClient SecurityServiceClient
