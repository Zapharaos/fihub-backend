...
func TestBrokerPostgresRepository_Create(t *testing.T) {
	...
	repositories.ReplaceGlobals(repositories.NewRepository(repositories.NewPostgresRepository(sqlxMock.DB), nil, nil))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			_, err := repositories.R().B().Create(models.Broker{})
...
func TestBrokerPostgresRepository_Get(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			_, found, err := repositories.R().B().Get(tt.id)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_Update(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			err := repositories.R().B().Update(tt.broker)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_Delete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			err := repositories.R().B().Delete(tt.id)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_Exists(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			exists, err := repositories.R().B().Exists(tt.id)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_ExistsByName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			exists, err := repositories.R().B().ExistsByName(tt.brokerName)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_GetAllEnabled(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			b, err := repositories.R().B().GetAllEnabled()
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_SetImage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			err := repositories.R().B().SetImage(tt.id, tt.imageID)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_HasImage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			exists, err := repositories.R().B().HasImage(tt.id)
			if (err != nil) != tt.expectErr {
...
func TestBrokerPostgresRepository_DeleteImage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.mockSetup()
			err := repositories.R().B().DeleteImage(tt.id)
			if (err != nil) != tt.expectErr {
