...
// ExtractUserIDFromToken extracts the user ID from the JWT token without verifying the signature
func (s *AuthService) ExtractUserIDFromToken(ctx context.Context, req *authpb.ExtractUserIDFromTokenRequest) (*authpb.ExtractUserIDFromTokenResponse, error) {
	...
	return &authpb.ExtractUserIDFromTokenResponse{UserId: userID}, nil
}
