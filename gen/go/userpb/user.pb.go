...
type CreateUserRequest struct {
	...
	Checkbox      bool                   `protobuf:"varint,4,opt,name=checkbox,proto3" json:"checkbox,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateUserPasswordRequest) GetConfirmation() string {
	if x != nil {
		return x.Confirmation
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"updated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x85\x01\n" +
	"\x11CreateUserRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\"\n" +
	"\fconfirmation\x18\x03 \x01(\tR\fconfirmation\x12\x1a\n" +
	"\bcheckbox\x18\x04 \x01(\bR\bcheckbox\"4\n" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\"\n" +
	"\fconfirmation\x18\x03 \x01(\tR\fconfirmation\"6\n" +
	...
	"\x10AuthenticateUser\x12\x1d.user.AuthenticateUserRequest\x1a\x1e.user.AuthenticateUserResponseB\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*UpdateUserPasswordRequest)(nil),  // 9: user.UpdateUserPasswordRequest
	(*UpdateUserPasswordResponse)(nil), // 10: user.UpdateUserPasswordResponse
	...
	(*AuthenticateUserRequest)(nil),    // 15: user.AuthenticateUserRequest
	(*AuthenticateUserResponse)(nil),   // 16: user.AuthenticateUserResponse
...
var file_user_proto_depIdxs = []int32{
	...
	0,  // 4: user.GetByEmailResponse.user:type_name -> user.User
	0,  // 5: user.UpdateUserResponse.user:type_name -> user.User
	0,  // 6: user.ListUsersResponse.users:type_name -> user.User
	0,  // 7: user.AuthenticateUserResponse.user:type_name -> user.User
	...
	5,  // 10: user.UserService.GetByEmail:input_type -> user.GetByEmailRequest
	7,  // 11: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	9,  // 12: user.UserService.UpdateUserPassword:input_type -> user.UpdateUserPasswordRequest
	11, // 13: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	13, // 14: user.UserService.ListUsers:input_type -> user.ListUsersRequest
	15, // 15: user.UserService.AuthenticateUser:input_type -> user.AuthenticateUserRequest
	...
	6,  // 18: user.UserService.GetByEmail:output_type -> user.GetByEmailResponse
	8,  // 19: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
	10, // 20: user.UserService.UpdateUserPassword:output_type -> user.UpdateUserPasswordResponse
	12, // 21: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	14, // 22: user.UserService.ListUsers:output_type -> user.ListUsersResponse
	16, // 23: user.UserService.AuthenticateUser:output_type -> user.AuthenticateUserResponse
