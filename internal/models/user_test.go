...
// TestHasPermission tests the HasPermission method of the UserWithRoles struct
func TestHasPermission(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			user:       createUserWithPermission("admin.Users.read"),
		...
		},
		{
			...
			user:       createUserWithPermission("admin.Users.*"),
			permission: "admin.Users.read",
			expected:   true,
		},
	}
