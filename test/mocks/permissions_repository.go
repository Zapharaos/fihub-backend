...
// Source: permissions/repository.go
//
// Generated by this command:
//
//	mockgen -source=permissions/repository.go -destination=../../test/mocks/permissions_repository.go --package=mocks -mock_names=Repository=PermissionsRepository Repository
//
