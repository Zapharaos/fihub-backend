...
//
//	mockgen -source=image_repository.go -destination=../../../../test/mocks/broker_repository_image.go --package=mocks -mock_names=ImageRepository=BrokerImageRepository ImageRepository
//
