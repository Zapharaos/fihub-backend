...
// Source: ../../../../protogen/health/health_grpc.pb.go
//
// Generated by this command:
//
//	mockgen -source=../../../../protogen/health/health_grpc.pb.go -destination=../../../../test/mocks/health_client.go -package=mocks -mock_names=HealthServiceClient=HealthServiceClient HealthServiceClient
//
...
import (
	...
	health "github.com/Zapharaos/fihub-backend/protogen/health"
...
func (m *HealthServiceClient) CheckHealth(ctx context.Context, in *health.HealthRequest, opts ...grpc.CallOption) (*health.HealthResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
...
// CheckHealth mocks base method.
func (m *MockHealthServiceServer) CheckHealth(arg0 context.Context, arg1 *health.HealthRequest) (*health.HealthResponse, error) {
	m.ctrl.T.Helper()
