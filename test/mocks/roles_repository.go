...
// Source: roles/repository.go
//
// Generated by this command:
//
//	mockgen -source=roles/repository.go -destination=../../test/mocks/roles_repository.go --package=mocks -mock_names=Repository=RolesRepository Repository
//
