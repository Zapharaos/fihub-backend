...
//
//	mockgen -source=user_repository.go -destination=../../../../test/mocks/broker_repository_user.go --package=mocks -mock_names=UserRepository=BrokerUserRepository UserRepository
//
